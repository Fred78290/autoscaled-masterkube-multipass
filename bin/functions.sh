...
export EXPOSE_PUBLIC_PORTS=${EXPOSE_PUBLIC_PORTS}
...
function create_cluster() {
	...
	CERT_SANS=$(collect_cert_sans "${LOAD_BALANCER_IP},${CLUSTER_NODES},${MASTERKUBE}.${PRIVATE_DOMAIN_NAME},${MASTERKUBE}.${PUBLIC_DOMAIN_NAME},${MASTERKUBE},${CONTROL_PLANE_ENDPOINT}")
